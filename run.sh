...
save_name=clp_wolog_df_real2complex_res_10layer_Semi_2w_MSA_DFSMN-fixbug_Time-SiSNR_wsj_${target_mode}_${lr}_${rnn_layers}_${rnn_units}_${sample_rate}_${win_len}_${win_inc}
